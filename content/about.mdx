...
[data sources](https://data-staging.niaid.nih.gov/portal/sources/) and view our [metadata schema](https://discovery.biothings.io/view/nde) for datasets contained in the Discovery Portal.
