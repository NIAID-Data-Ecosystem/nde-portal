...
- **We include a limited number of data sources.**
The Discovery Portal does not aggregate every dataset from every source related to infectious and allergic disease. The Discovery Portal pulls from a [list of data sources](https://data-staging.niaid.nih.gov/portal/sources/). If there are data sources you’d like us to include, you may [suggest a source](https://github.com/NIAID-Data-Ecosystem/nde-crawlers/issues/new?assignees=&labels=&template=suggest-a-new-resource.md&title=%5BSOURCE%5D).
...
- **You cannot directly download data or analyze it within the Discovery Portal.**
...
The Discovery Portal attempts to standardize metadata that is available; however, we cannot create information that does not exist. If metadata is missing at the source, it will also be absent within the Discovery Portal.
...
[Scripps Research](https://www.scripps.edu/) to build the NIAID Data
Ecosystem.
...
Haag, Laura D. Hughes, Jason Lin, Zhongchao Qian, Andrew I. Su, Sai Lakshmi
Subramanian, Ginger Tsung, Zorana Mitrovic Vucicevic, Dylan Welzel, Chunlei Wu.
The NIAID Data Ecosystem. Available online: https://data.niaid.nih.gov
