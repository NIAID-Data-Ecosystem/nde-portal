...
import { ResourceCatalogCard } from '../results-list/components/compact-card/resource-catalog-card';
import { DiseaseOverviewCard } from '../results-list/components/compact-card/disease-overview-card';
