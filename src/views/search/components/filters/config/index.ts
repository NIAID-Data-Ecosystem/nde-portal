...
export const FILTER_CONFIGS: FilterConfig[] = [
  ...
  {
    _id: 'anatomicalStructure.name',
    vizId: 'anatomicalStructure.name',
    name: 'Anatomical Structure',
    property: 'anatomicalStructure.name',
    tabIds: ['s'],
    description: getMetadataDescription('anatomicalStructure') || '',
    createQueries: buildQueries(),
  },
  {
    _id: 'anatomicalSystem.name',
    vizId: 'anatomicalSystem.name',
  ...
  // {
  //   _id: 'associatedGenotype',
  //   vizId: 'associatedGenotype',
  ...
  // {
  //   _id: 'developmentalStage',
  //   vizId: 'developmentalStage',
  //   name: 'Developmental Stage',
  //   property: 'developmentalStage',
  //   tabIds: ['s'],
  //   description: getMetadataDescription('developmentalStage') || '',
  //   createQueries: buildQueries(),
  // },
  // {
  //   _id: 'itemLocation',
  ...
  //   tabIds: ['s'],
  //   description: getMetadataDescription('itemLocation') || '',
  //   createQueries: buildQueries(),
  // },
  // {
  //   _id: 'locationOfOrigin',
  //   vizId: 'locationOfOrigin',
  //   name: 'Location of Origin',
  //   property: 'locationOfOrigin',
  //   tabIds: ['s'],
  //   description: getMetadataDescription('locationOfOrigin') || '',
  //   createQueries: buildQueries(),
  // },
  // {
  //   _id: 'sampleAvailability',
  //   vizId: 'sampleAvailability',
  //   name: 'Sample Availability',
  //   property: 'sampleAvailability',
  //   tabIds: ['s'],
  //   description: getMetadataDescription('sampleAvailability') || '',
  //   createQueries: buildQueries(),
  // },
  // {
  //   _id: 'sampleQuantity',
  //   vizId: 'sampleQuantity',
  //   name: 'Sample Quantity',
  //   property: 'sampleQuantity',
  //   tabIds: ['s'],
  //   description: getMetadataDescription('sampleQuantity') || '',
  //   createQueries: buildQueries(),
  // },
  // {
  //   _id: 'sampleType',
