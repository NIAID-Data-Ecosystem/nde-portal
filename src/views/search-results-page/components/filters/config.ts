...
export const FILTER_CONFIGS: FilterConfig[] = [
  ...
  {
    _id: 'applicationCategory',
    name: 'Application Category',
    property: 'applicationCategory',
    description: getSchemaDescription('applicationCategory'),
    createQueries: buildQueries(),
  },
  {
    ...
    description: getSchemaDescription('availableOnDevice'),
    createQueries: buildQueries(),
  },
  {
    _id: 'featureList.name',
    name: 'Feature List',
    property: 'featureList.name',
    description: getSchemaDescription('featureList'),
    createQueries: buildQueries(),
  },
  {
    _id: 'input.name',
    name: 'Input',
    property: 'input.name',
    description: getSchemaDescription('input'),
    createQueries: buildQueries(),
  },
  {
    _id: 'operatingSystem',
    ...
    description: getSchemaDescription('operatingSystem'),
    createQueries: buildQueries(),
  },
  {
    _id: 'output.name',
    ...
    description: getSchemaDescription('output'),
    createQueries: buildQueries(),
  },
  {
