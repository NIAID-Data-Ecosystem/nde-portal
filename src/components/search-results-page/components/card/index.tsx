...
import TypeBanner from 'src/components/resource-sections/components/type-banner';
...
import { ConditionsOfAccess } from 'src/components/badges/components/ConditionsOfAccess';
