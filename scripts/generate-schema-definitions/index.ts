...
generateSchemaDefinitions()
  .then(async newSchemaData => {
    const output = {
      $comment:
        'This file is auto-generated by scripts/generate-schema-definitions/index.ts. Do not edit it manually — your changes will be overwritten.',
      ...newSchemaData,
    };
