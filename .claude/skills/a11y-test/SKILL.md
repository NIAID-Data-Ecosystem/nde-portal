...
description: >-
  ...
  "accessibility test for <page>", "write an a11y spec". Not for Jest unit
  tests or non-accessibility e2e.
---
...
Use `e2e/accessibility/repository-matcher.spec.ts` as the canonical example to
match.
